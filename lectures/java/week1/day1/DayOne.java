public class DayOne {
	...
	// The return statement that is returning a string that is formated and using
	// the passed in arguments
	// Both returns will work...just not at the same time please.
	public static String favNum(String name, int num) {
		// return String.format("Hey everyone guess what? " + name + " has a favorite
		// number of " + num);
...
// all if statements will be checked. If else is where it will check the if and
// then else if, stopping when it finds a true else if