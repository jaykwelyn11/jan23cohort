...
Coffee Mocha = new Coffee("Mocha", "Brown", 102.1, false, 200, "Medium", "Columbian");
...
Wine Zinfandel = new Wine("White Zinfandel", "White", 40, false, 200, "Cali", 1999);
...
AllBeverages.Add(Mocha);
AllBeverages.Add(Large);
AllBeverages.Add(Regular);
AllBeverages.Add(Zinfandel);
